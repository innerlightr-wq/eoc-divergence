...
| # | claim | label | source |
|---|---|---|---|
| 1 | drift identity; `E_N` bounds | PROVED (paper) | *Valuation-Mean Classification* §1 |
| 2 | three orbit types, disjoint means, boundary `log₂3` | PROVED (paper) | same, main theorem |
...
| 12 | `N^{−3/2}`, renewal phase, Beatty jump sets | PROVED (paper) | *Three Scales of Confinement* — **DOI needed, see §6** |
...
1. **DOIs.** *Three Scales of Confinement* and *Valuation-Mean Classification* have **no DOI
   recorded anywhere in either repository**, and they are not in the manifest of the Structured
   Sectors collection (`10.5281/zenodo.20556483`, current version `10.5281/zenodo.22918600`,
   31 files). I have the PDFs locally (`~/Downloads/ScalesConfinement (1).pdf`,
   `~/Downloads/Lyapunov_Collatz_revision (1).pdf`) and have read both abstracts. **Please give
   me the DOIs, or say "cite as unpublished technical notes".**
2. **Title** — A, B, C or D from §0.

Also for confirmation, not blocking: I will cite the Sturmian paper as **v1 only**
(`10.5281/zenodo.22920056`) and describe the all-slopes extension as *in preparation*, per the
brief; and I will describe the `> β` density exclusion as **claimed in an unrefereed preprint**
every time it appears, never as known.
