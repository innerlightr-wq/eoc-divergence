...
holder ($92$ of $93$; the exception is $N=13$, $\Delta_1=-0.40$);
\emph{unlike} $3x+1$, it grows --- least-squares slope $+0.0224$
per unit $N$, Theil--Sen $+0.0224$, and block-bootstrap $95\%$ intervals excluding
...
measured rather than assumed. \textbf{The effective sample size is $n_{\mathrm{eff}}\approx3.0$ for
$5x-1$} (lag-one autocorrelation $0.94$; $6.3$ for $3x+1$), so the intervals must
not be read as if there were $93$ independent observations.
...
qualitative reading survives the correction unchanged; the numbers moved. The
$p_N$ column did not move at any $N$, the exact mass recursion never having been
involved, and the $3x+1$ column is unaffected and was re-verified. See
\texttt{audits/cross\_map/CORRECTION\_2026-09-25.md}.
\end{remark}
